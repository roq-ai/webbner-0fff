...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'perfume-designer', 'marketing-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    },
    {
      ...
      path: '/branded-contents',
      entity: 'branded_content',
      service: AccessServiceEnum.PROJECT,
      icon: FiFileText,
    },
    {
      name: 'End Customer Preference',
      path: '/end-customer-preferences',
      entity: 'end_customer_preference',
      service: AccessServiceEnum.PROJECT,
      icon: FiHeart,
    },
    { name: 'Perfume', path: '/perfumes', entity: 'perfume', service: AccessServiceEnum.PROJECT, icon: FiDroplet },
