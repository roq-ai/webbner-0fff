...
import { getBrandedContentById } from 'apiSdk/branded-contents';
...
function BrandedContentViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Branded Content Detail View
          </Text>
          {hasAccess('branded_content', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/branded-contents/edit/${data?.id}`} passHref legacyBehavior>
              <Button
